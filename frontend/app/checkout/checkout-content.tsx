    ...
    <div className="min-h-screen bg-[#FFFDF5]">
      ...
      <header className="sticky top-0 z-50 bg-[#FFFDF5] border-b border-gray-200">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <Link href="/" className="text-yellow-600 font-bold text-sm hover:text-yellow-700">
            ← Volver
          </Link>
        </nav>
      </header>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="bg-white/80 border border-gray-200 rounded-2xl p-8">
              <h2 className="text-3xl font-bold text-blue-950 mb-8">Resumen de tu Compra</h2>
              ...
              <div className="space-y-4 mb-8 pb-8 border-b border-gray-200">
                ...
                <div className="flex justify-between items-center text-lg">
                  ...
                  <span className="text-2xl font-bold text-yellow-600">{pricing.display}</span>
                </div>
              </div>
            ...
            {/* Checkout Form */}
            <div className="bg-white/80 border border-gray-200 rounded-2xl p-8">
              <h3 className="text-2xl font-bold text-blue-950 mb-8">Información de Contacto</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-yellow-600 focus:ring-1 focus:ring-yellow-600 text-blue-950 placeholder-gray-400 transition-all"
                ...
                <button
                  ...
                  className="w-full mt-8 px-6 py-3 text-lg font-bold text-white bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-lg hover:from-yellow-600 hover:to-yellow-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                >
