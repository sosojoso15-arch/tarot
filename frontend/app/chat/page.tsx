...
const CSS = `
  ...
  *{box-sizing:border-box}html,body{margin:0;padding:0}
  ...
  .nbtn{width:100%;background:linear-gradient(180deg,#c89a47,#a87a30);border:none;color:#fff8e1;padding:14px;border-radius:8px;font-family:'Cinzel',serif;font-size:14px;letter-spacing:.1em;cursor:pointer;box-shadow:0 6px 20px rgba(168,122,48,.35);}
